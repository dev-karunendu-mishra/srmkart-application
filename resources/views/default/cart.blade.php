            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 pr-lg-4">
                        ...
                        <tbody>
                            ...
                            <tr class="cart-item-row">
                                ...
                                <td class="product-close">
                                    <a href="#" class="product-remove cursor-pointer" title="Remove this product"
                    ...
                    <div class="cart-actions mb-6 pt-4">
                        ...
                        <button type="submit" class="btn btn-outline btn-dark btn-md btn-rounded {{empty($cartItems) || count($cartItems) == 0 ? 'btn-disabled' : ''}}">Clear Cart</button>
                    </div>
