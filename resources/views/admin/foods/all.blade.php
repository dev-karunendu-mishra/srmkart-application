<x-admin-app-layout>
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link {{!$errors->any() && empty(session('order_status')) ? 'active' : ''}}" id="nav-home-tab" data-bs-toggle="tab"
            ...
            <button class="nav-link {{ session('order_status') ? 'active' : '' }}" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact"
                type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Food Orders</button>
        </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade p-2 {{!$errors->any() && empty(session('order_status')) ? 'active show' : ''}}" id="nav-home" role="tabpanel"
        ...
        <div class="tab-pane fade {{ session('order_status') ? 'active show' : '' }}" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
