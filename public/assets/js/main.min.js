        ...
        (Riode.$window = $(window)),
            ...
            (Riode.doLoading = function (e, t) {
                ...
                void 0 === t
                    ...
                    : "small" == t
                        ...
                        : "simple" == t &&
                        i.append('<div class="d-loading small"></div>'),
                    "static" == i.css("position") &&
                    Riode.$(e).css("position", "relative");
            }),
            (Riode.endLoading = function (e) {
                Riode.$(e).find(".d-loading").remove(),
                    Riode.$(e).css("position", "");
            }),
            (Riode.appear =
                ((t = []),
                    (i = !1),
                    (n = function () {
                        for (var i = t.length; i--;)
                            (e = t[i]),
                                ...
                                ("function" ==
                                    typeof $(e.el).data("appear-callback") &&
                                    $(e.el)
            ...
            (Riode.closeTopNotice = function (e) {
                ...
                t.on("click", function (e) {
                    e.preventDefault(),
                        t.closest(".top-notice").css("display", "none");
                });
            }),
                    ...
                    var i,
                        ...
                        a = function () {
                            ((i = t[0].offsetHeight),
                                ...
                                t.find(".category-dropdown .dropdown-box")
                                    .length &&
                                (n += t.find(
            ...
            (Riode.ratingTooltip = function (e) {
                for (
                    ...
                    n = function () {
                        ...
                        this.lastElementChild.innerText = e
                            ? e.toFixed(2)
                            : e;
                    },
                    o = 0;
                    ...
                    (i.prototype.toggle = function () {
                        ...
                        if (
                            ...
                            if (
                                (e.isNavigation &&
                                    (t ||
                                        e.$sidebar.find(".filter-clean").hide(),
                                        e.$sidebar
                                            .siblings(".toolbox")
                                            .children(":not(:first-child)")
                                            .fadeToggle("fast"),
            ...
            //             (a.$wrapper = e),
            //                 (a.isQuickview =
            //                     !!e.closest(".mfp-content").length),
            //                 (a._isPgvertical = !1),
            //                 a.isQuickview &&
            //                 ((o = o.bind(this)), Riode.ratingTooltip()),
            //                 s
            ...
            //                 (Riode.slider(s),
            //                     Riode.quantityInput(e.find(".quantity"))),
            //                 (function (e) {
            ...
            //                 //                         .val(),
            //                 //                     actionTemplate:
            //                 //                         '<div class="action-group d-flex mt-3"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
            //                 //                 });
            //                 //         }
            //                 //     );
            //                 // })(this),
            ...
            (Riode.initProductSinglePage = (function () {
                function e(e) {
                    ...
                    $(".cart-added-alert").remove(),
                        $(
                            Riode.parseTemplate(
                                Riode.defaults.templateCartAddedAlert,
                ...
                function t(e) {
                    // var t = $(e.currentTarget).closest(".product-single");
                    // "disabled" !=
                    //     t.find(".btn-product.btn-cart").attr("disabled") &&
                    //     Riode.Minipopup.open({
                    //         message: "Successfully Added",
                    //         productClass: "product-compare",
                    //         name: t.find("h1.product-name").text(),
                        ...
                        (e.preventDefault(),
                            ...
                            setTimeout(function () {
                                t.removeClass("load-more-overlay loading")
                                    .html(
                                        '<i class="d-icon-heart-full"></i> Browse wishlist'
                                    )
                                    .addClass("added")
                                ...
                                : null === Riode.initProductSingle(s)
                                    ...
                                    : (Riode.$body.on(
                                        ...
                                        Riode.$body.on(
                                            ...
                                            function (e) {
                                                $(".review-form-section").toggleClass(
                                                    "opened"
                                                ),
                                                    e.stopPropagation(),
                                                    e.preventDefault();
                                        ...
                                        Riode.$body.on(
                                            ...
                                            ".review-overlay",
                                            function (e) {
                                                $(".review-form-section").removeClass(
                                                    "opened"
                                                ),
                                                    e.stopPropagation();
                                            }
            ...
            (Riode.CommentWithMedia = {
                init: function () {
                    Riode.$body
                        .on(
                            "change",
                            '.review-medias input[type="file"]',
                            this.uploadMedia
                        )
                        .on(
                            "click",
                            ".review-medias .btn-remove",
                            this.removeMedia
                        );
                },
                    ...
                    if ($(this)[0].files.length) {
                        ...
                        o &&
                            (n.hasClass("image-input")
                                ...
                                : n.hasClass("video-input") &&
                                n.find("video").attr("src", o));
                    }
                },
            ...
            (Riode.slider = (function () {
                ...
                var t = function (e) {
                    ...
                    if (
                        ...
                        for (
                            var n = this.children, o = n.length, a = 0;
                            a < o;
                            ++a
                        )
                        ...
                        s.find("video").on("ended", function () {
                            $(this).closest(".owl-item").hasClass("active") &&
                                (!0 === s.data("owl.carousel").options.autoplay
                                    ? (!1 ===
                                        s.data("owl.carousel").options.loop &&
                                        s.data().children - 1 ===
                                        s
                    ...
                    n = function (e) {
                        ...
                        t
                            ...
                            i.length &&
                            (!0 ===
                                t.data("owl.carousel").options.autoplay &&
                    ...
                    r = function (e) {
                        ...
                        if (1 == t.translateFlag) {
                            if (
                                ...
                                i.find(".owl-item.active .slide-animate").each(
                                    function () {
                                        var e = $(this),
                                            i = $.extend(
                                                !0,
            ...
            (Riode.quantityInput = (function () {
                ...
                //             (t.increaseTimer = Riode.requestTimeout(
                //                 function () {
                //                     (t.speed = 1),
                //                         (t.increaseTimer =
                //                             Riode.requestInterval(function () {
                //                                 t.$value.val(
                //                                     (t.value = Math.min(
                //                                         t.value +
                //                                         Math.floor(
                ...
                //             (e.decreaseTimer = Riode.requestTimeout(
                //                 function () {
                //                     (e.speed = 1),
                //                         (e.decreaseTimer =
                //                             Riode.requestInterval(function () {
                ...
                //         Riode.$(t).each(function () {
                //             var t = $(this);
                //             t.data("quantityInput") ||
                //                 t.data("quantityInput", new e(t));
                //         });
                //     }
                // );
            })()),
            (Riode.Menu = {
                ...
                initMenu: function () {
                    $(".menu li").each(function () {
                        ...
                        Riode.$window.on("resize", function () {
                            $(
                                ".main-nav .megamenu, .main-nav .submenu > ul"
                            ).each(function () {
                                var e = $(this),
                                    t = e.offset().left,
                                    i = e.outerWidth(),
                ...
                initCollapsibleWidget: function () {
                    $(".widget-collapsible .widget-title").each(function () {
                        ...
                        $(".widget-collapsible .widget-title").on(
                            "click",
                            function (e) {
                                var t = $(this);
                    ...
                    init: function () {
                        ...
                        (t.className = "minipopup-area"),
                            ...
                            (e = $(t)).on("click", ".btn-close", function (e) {
                                self.close(
                                    $(this).closest(".minipopup-box").index()
                                );
                            }),
                ...
                return (
                    ...
                    (e.prototype.start = function () {
                        (this.update = this.update.bind(this)),
                            (this.timeStart =
                                Date.now() - parseInt(100 * Math.random())),
                            this.$el.find("path").each(function () {
                                $(this).data(
                                    "original",
                                    this.getAttribute("d").replace(
                                        /([\d])\s*\-/g,
                                        "$1,-"
                                    )
                                );
            ...
            (Riode.Shop = {
                ...
                initProductType: function (e) {
                    "slideup" === e &&
                        ($(".product-slideup-content .product-details").each(
                            function (e) {
                                var t = $(this),
                                    i = t
                ...
                initSelectMenu: function () {
                    Riode.$body
                        ...
                        .on("click", ".filter-clean", function (e) {
                            $(
                                ".shop-sidebar .filter-items .active"
                            ).removeClass("active"),
                                e.preventDefault();
                        })
                ...
                initProductsCartAction: function () {
                    Riode.$body
                        ...
                        .on(
                            "click",
                            ".off-canvas .canvas-header .btn-close",
                            function (e) {
                    ...
                    // .on(
                    //     "click",
                    //     ".product:not(.product-variable) .btn-product-icon.btn-cart:not(.btn-enquiry), .product:not(.product-variable) .btn-product.btn-cart:not(.btn-enquiry)",
                    //     function (e) {
                    //         const _this = this;
                    //         e.preventDefault();

                    //         // Check if the target has the required attribute
                    //         if (e.target.matches('.btn-cart') && e.target.hasAttribute('data-product-uuid')) {
                    //             const productUUID = e.target.getAttribute('data-product-uuid');
                    //             if (productUUID) {
                    //                 // Access CSRF token from the meta tag
                    //                 const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                    //                 const data = { uuid: productUUID };
                    ...
                    //                             var t,
                    //                                 i,
                    //                                 n = $(_this).closest(".product"),
                    //                                 o = $(_this).closest(".compare-col");
                    //                             $(_this).closest(".compare-row");
                    //                             o.length > 0
                    //                                 ? ((t = $(
                    ...
                    //                                     Riode.Minipopup.open({
                    //                                         message: "Karunendu Successfully Added",
                    //                                         productClass: "product-cart",
                    //                                         name: i.find("a").text(),
                    //                                         nameLink: i
                    //                                             .find(" a ")
                    ...
                    //                                             : 1,
                    //                                     actionTemplate:
                    //                                         '<div class="action-group d-flex"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>',
                    //                                 });
                    //                         }
                    //                     })
                    //                     .catch(error => {
                    ...
                    //     //     price: t
                    //     //         .find(
                    //     //             ".tooltip-price .new-price, .tooltip-price .price"
                    //     //         )
                    //     //         .html(),
                    //     //     count:
            ...
            (Riode.init = function () {
                Riode.appearAnimate(".appear-animate"),
                    ...
                    Riode.stickyContent(
                        ".product-sticky-content, .sticky-header",
                        { top: !1 }
                    ),
                    Riode.stickyContent(
                        ".sticky-footer",
                        Riode.defaults.stickyFooter
                    ),
                    Riode.stickyContent(
                        ".sticky-toolbox",
                        Riode.defaults.stickyToolbox
                    ),
